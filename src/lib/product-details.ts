...
const studio: Record<ProductLocale, ProductCopy> = {
  zh: {
    ...
    storyHook: "把工作室主页变成可转发、可信任、可转化的第一印象。",
    ctaLabel: "Work with Void Architect",
    ctaTitle: "把你的 AI 产品，也做成能被看懂的空间入口。",
    ctaBody: "如果你需要把复杂能力包装成清晰产品页，先从一次高信号产品诊断开始。",
    ctaPrimary: "发起产品诊断",
    ctaSecondary: "回到产品橱窗",
  ...
  en: {
    ...
    storyHook: "A public storefront that turns studio credibility into product demand.",
    ctaLabel: "Work with Void Architect",
    ctaTitle: "Turn your AI product into a storefront people understand.",
    ctaBody: "If your product is powerful but hard to explain, start with a high-signal product diagnosis.",
    ctaPrimary: "Start a product diagnosis",
    ctaSecondary: "Back to gallery",
...
const brain: Record<ProductLocale, ProductCopy> = {
  zh: {
    ...
    storyHook: "个人知识第二大脑：把资料、引用和报告连成一个可调用系统。",
    ctaLabel: "Build Knowledge OS",
    ctaTitle: "让你的资料库开始回答、引用和产出。",
    ctaBody: "适合研究、咨询、工程和高密度知识工作，把长期文本资产转成认知杠杆。",
    ctaPrimary: "聊知识库场景",
    ctaSecondary: "查看其他产品",
  ...
  en: {
    ...
    storyHook: "A second brain for documents, citations, and reusable research output.",
    ctaLabel: "Build Knowledge OS",
    ctaTitle: "Make your knowledge base answer, cite, and write.",
    ctaBody: "For research, consulting, engineering, and dense knowledge work where text assets should become leverage.",
    ctaPrimary: "Discuss a knowledge system",
    ctaSecondary: "See other products",
...
const hermes: Record<ProductLocale, ProductCopy> = {
  zh: {
    ...
    storyHook: "AI 桌面驾驶舱：让伙伴、任务和运行态进入同一个控制面。",
    ctaLabel: "Design Agent Cockpit",
    ctaTitle: "把 AI 协作从聊天窗口推进到桌面控制舱。",
    ctaBody: "适合长任务、多模型、语音入口和可观察执行流，不再把工作丢在聊天记录里。",
    ctaPrimary: "聊 Agent 控制舱",
    ctaSecondary: "查看其他产品",
  ...
  en: {
    ...
    storyHook: "A desktop cockpit for agents, tasks, voice, and runtime state.",
    ctaLabel: "Design Agent Cockpit",
    ctaTitle: "Move AI collaboration from chat into an operational cockpit.",
    ctaBody: "For long-running tasks, multi-model workflows, voice entry, and observable execution instead of buried chat logs.",
    ctaPrimary: "Discuss an agent cockpit",
    ctaSecondary: "See other products",
...
const recorder: Record<ProductLocale, ProductCopy> = {
  zh: {
    ...
    storyHook: "屏幕行动记忆：把调试、研究和演示过程沉淀成可检索上下文。",
    ctaLabel: "Capture Work Memory",
    ctaTitle: "别再让屏幕操作完成后就消失。",
    ctaBody: "适合调试复盘、教学演示、操作 SOP 和 agent 记忆入口，把过程变成资产。",
    ctaPrimary: "聊屏幕记忆",
    ctaSecondary: "查看其他产品",
  ...
  en: {
    ...
    storyHook: "Screen action memory for debugging, research, demos, and operational replay.",
    ctaLabel: "Capture Work Memory",
    ctaTitle: "Stop letting screen work disappear after it happens.",
    ctaBody: "For debugging review, teaching demos, operational SOPs, and agent memory inlets that turn process into assets.",
    ctaPrimary: "Discuss screen memory",
    ctaSecondary: "See other products",
...
const texas: Record<ProductLocale, ProductCopy> = {
  zh: {
    ...
    storyHook: "策略训练游戏：把概率、风险和性格识别做成可玩的成长系统。",
    ctaLabel: "Prototype Training Game",
    ctaTitle: "把抽象策略训练做成高频反馈游戏。",
    ctaBody: "适合把复杂思维、决策纪律和人格识别做成可传播、可复玩、可成长的产品。",
    ctaPrimary: "聊训练游戏",
    ctaSecondary: "查看其他产品",
  ...
  en: {
    ...
    storyHook: "A playable growth system for probability, risk, and personality reading.",
    ctaLabel: "Prototype Training Game",
    ctaTitle: "Turn abstract strategy training into fast feedback gameplay.",
    ctaBody: "For products that translate complex thinking, discipline, and persona reading into something replayable and shareable.",
    ctaPrimary: "Discuss a training game",
    ctaSecondary: "See other products",
